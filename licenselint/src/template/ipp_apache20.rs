...
pub struct IppApache20Template;

impl IppApache20Template {
    const TEMPLATE: &'static str = r#"// Copyright {year} {author} <{email}>
//
...
impl LintTemplate for IppApache20Template {
